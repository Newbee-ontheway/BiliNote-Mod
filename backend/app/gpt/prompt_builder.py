...
- 总字数不限，以信息完整为优先。""",
        'tutorial': '4. **教程笔记**: 尽可能详细的记录教程，特别是关键点和一些重要的结论步骤',
        'academic': '5. **学术风格**: 适合学术报告，正式且结构化。',
        'xiaohongshu': """6. **小红书风格**:
### 擅长使用下面的爆款关键词：
...
7. 使用吸引人的标题""",
        'life_journal': '7. **生活向**: 记录个人生活感悟，情感化表达。',
        'task_oriented': '8. **任务导向**: 强调任务、目标，适合工作和待办事项。',
        'business': '9. **商业风格**: 适合商业报告，正式且精准。',
        'meeting_minutes': '10. **会议纪要**: 适合会议纪要，记录决议事项、行动项和讨论要点。',
    }
